...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./easing */ "./source/js/modules/canvas-animation/easing.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _easing__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
/***/ "./source/js/modules/canvas-animation/easing.js":
/*!******************************************************!*\
  !*** ./source/js/modules/canvas-animation/easing.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/canvas-animation/loose-scene.js":
/*!***********************************************************!*\
  !*** ./source/js/modules/canvas-animation/loose-scene.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scene */ "./source/js/modules/canvas-animation/scene.js");
/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./easing */ "./source/js/modules/canvas-animation/easing.js");
/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./animation */ "./source/js/modules/canvas-animation/animation.js");
...
class LooseScene extends _scene__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
  ...
  initKeyAnimations() {
    this.animations.push(new _animation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      ...
      duration: 200,
      delay: 0,
      easing: _easing__WEBPACK_IMPORTED_MODULE_1__["default"].easeOutExpo
    }));
  }
  ...
  initFlamingoAnimations() {
    ...
    this.animations.push(new _animation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      ...
      duration: 583,
      delay: 617,
      easing: _easing__WEBPACK_IMPORTED_MODULE_1__["default"].easeOutCubic
    }));
  }
  ...
  initCrocodileAnimation() {
    this.animations.push(new _animation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      ...
      duration: 600,
      delay: 300,
      easing: _easing__WEBPACK_IMPORTED_MODULE_1__["default"].easeLinear
    }));
  }

  initDropAnimation() {
    this.dropAnimations = [];
    this.dropAnimations.push(new _animation__WEBPACK_IMPORTED_MODULE_2__["default"]({
      func: (progress) => {
...
/* harmony default export */ __webpack_exports__["default"] = (LooseScene);


/***/ }),

/***/ "./source/js/modules/canvas-animation/primary-award-scene.js":
/*!*******************************************************************!*\
  !*** ./source/js/modules/canvas-animation/primary-award-scene.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scene */ "./source/js/modules/canvas-animation/scene.js");
/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animation */ "./source/js/modules/canvas-animation/animation.js");
/* harmony import */ var _easing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./easing */ "./source/js/modules/canvas-animation/easing.js");
...
class PrimaryAwardScene extends _scene__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
  ...
  initPlaneAnimations() {
    this.animations.push(new _animation__WEBPACK_IMPORTED_MODULE_1__["default"]({
      ...
      duration: 500,
      delay: 1200,
      easing: _easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutExpo
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _animation__WEBPACK_IMPORTED_MODULE_1__["default"]({
      ...
      duration: 2000,
      delay: 1000,
      easing: _easing__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/* harmony default export */ __webpack_exports__["default"] = (PrimaryAwardScene);


/***/ }),

/***/ "./source/js/modules/canvas-animation/scene.js":
/*!*****************************************************!*\
  !*** ./source/js/modules/canvas-animation/scene.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony import */ var _prize_counter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prize-counter */ "./source/js/modules/prize-counter.js");
...
class FullPageScroll {
  constructor() {
    ...
    this.gameTimer = new _timer__WEBPACK_IMPORTED_MODULE_1__["default"](this.counterFields, GAME_DURATION);
  ...
  startPrizeAnimation(prizeEl, animationOptions) {
    ...
    setTimeout(() => {
      ...
      const prizeCounter = new _prize_counter__WEBPACK_IMPORTED_MODULE_2__["default"](prizeAmount, counter);
      prizeCounter.start();
      img.src = `img/${svgFile}`;
    }, timeout);
  }
...
/* harmony default export */ __webpack_exports__["default"] = (PrizeCounter);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _canvas_animation_primary_award_scene__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas-animation/primary-award-scene */ "./source/js/modules/canvas-animation/primary-award-scene.js");
/* harmony import */ var _canvas_animation_loose_scene__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./canvas-animation/loose-scene */ "./source/js/modules/canvas-animation/loose-scene.js");
...
const initAnimation = (targetEl) => {
  ...
  switch (targetElementId) {
    case `result`:
      ...
      resultScene = new _canvas_animation_primary_award_scene__WEBPACK_IMPORTED_MODULE_0__["default"]();
      resultScene.start();
      break;
    case `result3`:
      playFailAnimation(animatedEl);
      resultScene = new _canvas_animation_loose_scene__WEBPACK_IMPORTED_MODULE_1__["default"]();
      resultScene.start();
      break;
    default:
      playVictoryAnimation(animatedEl);
...
/***/ "./source/js/modules/title-animation-switcher.js":
/*!*******************************************************!*\
  !*** ./source/js/modules/title-animation-switcher.js ***!
  \*******************************************************/
/*! exports provided: default */
...
class TitleAnimationSwitcher {
  ...
  init() {
    ...
    animatedTitles.forEach((item) => {
      this[item.name] = new _letter_animation__WEBPACK_IMPORTED_MODULE_0__["default"](item.selector, item.options);
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (TitleAnimationSwitcher);
...
/* harmony import */ var _modules_title_animation_switcher__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/title-animation-switcher */ "./source/js/modules/title-animation-switcher.js");
// modules
...
const titleAnimationSwitcher = new _modules_title_animation_switcher__WEBPACK_IMPORTED_MODULE_10__["default"]();
